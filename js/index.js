$(window).on('load',function(){
    ...
    //card producto index
    let path_fetch="api/interfaces/promociones.php";
        ...
        for(let f=0; f< response.length;f++){
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 360 632">
                ...
                <g id="f0e62cbf-4ba9-4ad2-883e-19ebe2817a1a" data-name="card">
                  ...
                  <g class="comprar-producto" value="${response[f].id_producto}">
                ...
                <g id="f21a9b1d-51db-4323-95f1-a9fc47aa2f39" data-name="stock">
                  <text class="eb7c4729-e31d-48b4-a780-3b04696e694b" transform="translate(281.27 485.96)">${response[f].stock}</text>
                </g>
                <g id="fe99fd18-c861-4898-a1d6-c75f694e2d90" data-name="img">
                  <image width="1322" height="1113" transform="translate(3 102) scale(0.27 0.26)" xlink:href="${response[f].img}"/>
                </g>
                <g id="e27e2678-efb7-4375-976a-ddb950241a7d" data-name="texto1">
                  <text class="efa87712-205c-4cd0-91cd-2e9d1e9f971d" transform="translate(30.58 31.18)">${response[f].nombre} </text>
                </g>
                <g data-name="texto1">
                ...
                <g id="ac5bb496-1782-4a77-a175-3bd9da31e5f8" data-name="texto agregar">
                  <text class="b06f0b4f-9b97-4524-aea2-9bb3af7bd5e7" transform="translate(184.34 81.42)">${response[f].info_corta}</text>
                </g>
              </svg>
