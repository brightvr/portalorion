...
<?php 
  ...
  if($_GET['collection_status']==="rejected" && $_GET['payment_type']==="credit_card"){

    echo '<div class="bg-light p-3">Pago rechazado , 
    al parecer tu pago no fue autorizado, por favor revisa tu correo para mas informacion<br><hr>
